...
export default function ConseilJoieInconnue({ navigation }) {
  return (
        ...
        <View style={styles.bulleConseilsJoie}>
          <ScrollView>
            ...
            <Text style={styles.conseil}>
              Si vous vous sentez joyeux.se, vous pouvez en parler avec votre
              entourage, en partageant votre enthousiasme. Vous pourrez
              peut-être égayer leur journée!
            </Text>

            <Text style={styles.titre2}> S'en souvenir</Text>
            <Text style={styles.conseil}>
              Il est très bénéfique pour beaucoup d’écrire sur les petites
              choses qui constituent notre quotidien. Alors, si vous vous sentez
              joyeux.se, n’hésitez pas à l’écrire : il pourra être bénéfique de
              vous rappeler un jour votre enthousiasme et votre sentiment de
              bien-être lorsqu’à l’avenir vous aurez besoin de motivation.
            </Text>
          </ScrollView>
        </View>
      </View>
