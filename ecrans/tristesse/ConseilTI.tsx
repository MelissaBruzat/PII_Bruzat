...
export default function ConseilTristesseInconnue({ navigation }) {
  return (
      ...
      <View style={styles.bulleConseilsTristesse}>
        <ScrollView>
          ...
          <Text style={styles.conseil}>
            Vous pouvez essayer d’en parler avec un proche, car il est important
            d'extérioriser sa tristesse et de ne pas se renfermer sur soi-même.
          </Text>
          ...
          <Text style={styles.titre2}> Ne pas se laisser submerger</Text>
          <Text style={styles.conseil}>
          ...
          <Text style={styles.conseil}>
            Prendre soin de soi Pensez à vous reposer et à dormir suffisamment,
            une alimentation saine et variée vous permettra aussi de mieux
            maîtriser et comprendre vos émotions : “un esprit sain dans un corps
            sain”.
          </Text>
        </ScrollView>
      </View>
